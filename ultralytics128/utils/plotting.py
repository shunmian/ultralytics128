...
from ultralytics128.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from ultralytics128.utils.checks import check_font, check_version, is_ascii
...
class Annotator:
    ...
    Examples:
        >>> from ultralytics128.utils.plotting import Annotator
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    """
    import matplotlib.pyplot as plt  # scope for faster 'import ultralytics128'
    import polars
...
def save_one_box(
    ...
    Examples:
        >>> from ultralytics128.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
