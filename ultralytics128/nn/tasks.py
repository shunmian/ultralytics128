...
from ultralytics128.nn.autobackend import check_class_names
from ultralytics128.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics128.utils import DEFAULT_CFG_DICT, LOGGER, YAML, colorstr, emojis
from ultralytics128.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics128.utils.loss import (
    E2EDetectLoss,
...
from ultralytics128.utils.ops import make_divisible
from ultralytics128.utils.patches import torch_load
from ultralytics128.utils.plotting import feature_visualization
from ultralytics128.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics128.models.utils.loss import RTDETRDetectionLoss
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from ultralytics128.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics128.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics128.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    Examples:
        >>> from ultralytics128.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from ultralytics128.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            modules={
                # Map original Ultralytics package/module paths to this fork for backwards-compatible weight loading.
                "ultralytics": "ultralytics128",
                "ultralytics.yolo.utils": "ultralytics128.utils",
                "ultralytics.yolo.v8": "ultralytics128.models.yolo",
                "ultralytics.yolo.data": "ultralytics128.data",
            },
            attributes={
                "ultralytics.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralytics.nn.tasks.YOLOv10DetectionModel": "ultralytics128.nn.tasks.DetectionModel",  # YOLOv10
                "ultralytics.utils.loss.v10DetectLoss": "ultralytics128.utils.loss.E2EDetectLoss",  # YOLOv10
            },
        ):
            if safe_only:
