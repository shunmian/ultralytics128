...
from ultralytics128.data.utils import IMG_FORMATS, img2label_paths
from ultralytics128.utils import DATASETS_DIR, LOGGER, TQDM
...
def autosplit(
    ...
    Examples:
        ...
        >>> from ultralytics128.data.split import autosplit
        >>> autosplit()
