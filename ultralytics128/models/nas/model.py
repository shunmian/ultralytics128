...
from ultralytics128.engine.model import Model
from ultralytics128.utils import DEFAULT_CFG_DICT
from ultralytics128.utils.downloads import attempt_download_asset
from ultralytics128.utils.patches import torch_load
from ultralytics128.utils.torch_utils import model_info
...
class NAS(Model):
    ...
    Examples:
        >>> from ultralytics128 import NAS
