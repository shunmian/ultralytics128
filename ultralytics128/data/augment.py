...
from ultralytics128.data.utils import polygons2masks, polygons2masks_overlap
from ultralytics128.utils import LOGGER, IterableSimpleNamespace, colorstr
from ultralytics128.utils.checks import check_version
from ultralytics128.utils.instance import Instances
from ultralytics128.utils.metrics import bbox_ioa
from ultralytics128.utils.ops import segment2box, xywh2xyxy, xyxyxyxy2xywhr
from ultralytics128.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics128.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics128.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class CutMix(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics128.data.augment import CutMix
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics128.data.augment import RandomHSV
    ...
    def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # lut_hue = ((x * (r[0] + 1)) % 180).astype(dtype)   # original hue implementation from ultralytics128<=8.3.78
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics128.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz: int, hyp: IterableSimpleNamespace, stretch: bool = False):
    ...
    Examples:
        ...
        >>> from ultralytics128.utils import IterableSimpleNamespace
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import ultralytics128'
