...
Usage:
    from ultralytics128.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics128 import YOLO, YOLOWorld
from ultralytics128.cfg import TASK2DATA, TASK2METRIC
from ultralytics128.engine.exporter import export_formats
from ultralytics128.utils import ARM64, ASSETS, ASSETS_URL, IS_JETSON, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR, YAML
from ultralytics128.utils.checks import IS_PYTHON_3_13, check_imgsz, check_requirements, check_yolo, is_rockchip
from ultralytics128.utils.downloads import safe_download
from ultralytics128.utils.files import file_size
from ultralytics128.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    **kwargs,
    ...
    Examples:
        ...
        >>> from ultralytics128.utils.benchmarks import benchmark
        >>> benchmark(model="yolo11n.pt", imgsz=640)
    """
    imgsz = check_imgsz(imgsz)
    assert imgsz[0] == imgsz[1] if isinstance(imgsz, list) else True, "benchmark() only supports square imgsz."

    import polars as pl  # scope for faster 'import ultralytics128'
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from ultralytics128.utils.benchmarks import ProfileModels
