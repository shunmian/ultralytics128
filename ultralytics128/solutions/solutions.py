...
from ultralytics128.utils import ASSETS_URL, LOGGER, ops
from ultralytics128.utils.checks import check_imshow, check_requirements
...
class BaseSolution:
    ...
    def __init__(self, is_cli: bool = False, **kwargs: Any) -> None:
        ...
        if is_cli and self.CFG["source"] is None:
            ...
            safe_download(f"{ASSETS_URL}/{d_s}")  # download source from ultralytics128 assets
