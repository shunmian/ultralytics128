...
from ultralytics128.utils.checks import check_file, check_font, is_ascii
from ultralytics128.utils.downloads import download, safe_download, unzip_file
from ultralytics128.utils.ops import segments2boxes
...
def visualize_image_annotations(image_path: str, txt_path: str, label_map: dict[int, str]):
    ...
    from ultralytics128.utils.plotting import colors
...
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    ...
    if not train_set.is_dir():
        ...
        if image_files := list(data_dir.rglob("*.jpg")) + list(data_dir.rglob("*.png")):
            from ultralytics128.data.split import split_classify_dataset
...
class HUBDatasetStats:
    ...
    Examples:
        >>> from ultralytics128.data.utils import HUBDatasetStats
    ...
    def get_json(self, save: bool = False, verbose: bool = False) -> dict:
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                from torchvision.datasets import ImageFolder  # scope for faster 'import ultralytics128'
    ...
    def process_images(self) -> Path:
        ...
        from ultralytics128.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f: str, f_new: str | None = None, max_dim: int = 1920, quality: int = 50):
    ...
    Examples:
        >>> from pathlib import Path
        >>> from ultralytics128.data.utils import compress_one_image
