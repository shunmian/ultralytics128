...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Examples:
        >>> from ultralytics128.utils.checks import parse_requirements
...
def check_font(font="Arial.ttf"):
    ...
    """
    from matplotlib import font_manager  # scope for faster 'import ultralytics128'
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Examples:
        >>> from ultralytics128.utils.checks import check_requirements
...
def check_yolo(verbose=True, device=""):
    ...
    from ultralytics128.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ultralytics128.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics128.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> from ultralytics128.utils.checks import check_amp
        >>> model = YOLO("yolo11n.pt").model.cuda()
        >>> check_amp(model)
    """
    from ultralytics128.utils.torch_utils import autocast
...
def is_intel():
    ...
    """
    from ultralytics128.utils.torch_utils import get_cpu_info
