...
from ultralytics128.data import ClassificationDataset, build_dataloader
from ultralytics128.engine.trainer import BaseTrainer
from ultralytics128.models import yolo
from ultralytics128.nn.tasks import ClassificationModel
from ultralytics128.utils import DEFAULT_CFG, RANK
from ultralytics128.utils.plotting import plot_images
from ultralytics128.utils.torch_utils import is_parallel, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    Examples:
        ...
        >>> from ultralytics128.models.yolo.classify import ClassificationTrainer
    ...
    def setup_model(self):
        ...
        """
        import torchvision  # scope for faster 'import ultralytics128'
