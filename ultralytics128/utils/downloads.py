...
from ultralytics128.utils import ASSETS_URL, LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path: str | Path, files_to_delete: tuple[str, ...] = (".DS_Store", "__MACOSX")) -> None:
    ...
    Examples:
        >>> from ultralytics128.utils.downloads import delete_dsstore
...
def zip_directory(
    ...
    Examples:
        >>> from ultralytics128.utils.downloads import zip_directory
...
def unzip_file(
    ...
    Examples:
        >>> from ultralytics128.utils.downloads import unzip_file
...
def get_google_drive_file_info(link: str) -> tuple[str, str | None]:
    ...
    Examples:
        >>> from ultralytics128.utils.downloads import get_google_drive_file_info
...
def attempt_download_asset(
    ...
    **kwargs,
    ...
    """
    from ultralytics128.utils import SETTINGS  # scoped for circular import
