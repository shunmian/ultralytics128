...
from ultralytics128.utils import ASSETS_URL, DATASETS_DIR, LOGGER, NUM_THREADS, TQDM, YAML
from ultralytics128.utils.checks import check_file, check_requirements
from ultralytics128.utils.downloads import download, zip_directory
from ultralytics128.utils.files import increment_path
...
def convert_coco(
    ...
    Examples:
        >>> from ultralytics128.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir: str, output_dir: str, classes: int):
    ...
    Examples:
        >>> from ultralytics128.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Examples:
        >>> from ultralytics128.data.converter import convert_dota_to_yolo_obb
    ...
    Notes:
        The input directory structure assumed for dataset:
            ...
            - labels
                ...
                └─ NNN.txt
    """
    from ultralytics128 import SAM
    from ultralytics128.data import YOLODataset
    from ultralytics128.utils.ops import xywh2xyxy
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from ultralytics128.data.converter import create_synthetic_coco_dataset
...
def convert_to_multispectral(path: str | Path, n_channels: int = 10, replace: bool = False, zip: bool = False):
    ...
    from ultralytics128.data.utils import IMG_FORMATS
