...
from ultralytics128.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from ultralytics128.data.utils import check_det_dataset
from ultralytics128.models.yolo.world import WorldTrainer
from ultralytics128.utils import DATASETS_DIR, DEFAULT_CFG, LOGGER
from ultralytics128.utils.torch_utils import unwrap_model
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Examples:
        >>> from ultralytics128.models.yolo.world.train_world import WorldTrainerFromScratch
        >>> from ultralytics128 import YOLOWorld
        >>> data = dict(
        ...     train=dict(
